...
%
% skipped imread and give abslute path to siftWin32
%
% This function reads an image and returns its SIFT keypoints.
%   Input parameters:
%     imageFile: Image Matrix(gray scale).
%
%   Returned:
...
function [image, descriptors, locs] = sift_ri(image)
...
if isunix
    ...
    command = '!C:\Users\yoshi\Documents\MATLAB\SIFT\siftWin32.exe ';
end
